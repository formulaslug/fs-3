...
class DataBatch {
    ...
    uint8_t SME_THROTL_UNUSED_BIT_1[ROWS_PER_BATCH/8];
    uint8_t SME_THROTL_PowerReady[ROWS_PER_BATCH/8];
    uint8_t SME_THROTL_UNUSED_BIT_2[ROWS_PER_BATCH/8];
    uint8_t SME_THROTL_UNUSED_BIT_3[ROWS_PER_BATCH/8];
    uint8_t SME_THROTL_UNUSED_BIT_4[ROWS_PER_BATCH/8];
    uint8_t SME_THROTL_UNUSED_BIT_5[ROWS_PER_BATCH/8];
    uint8_t SME_THROTL_MBB_Alive[ROWS_PER_BATCH];
    uint8_t SME_THROTL_UNUSED_BIT_6[ROWS_PER_BATCH/8];
    uint8_t SME_THROTL_UNUSED_BIT_7[ROWS_PER_BATCH/8];
    uint8_t SME_THROTL_UNUSED_BIT_8[ROWS_PER_BATCH/8];
    uint8_t SME_THROTL_UNUSED_BIT_9[ROWS_PER_BATCH/8];
    uint16_t SME_THROTL_UNUSED_SHORT_1[ROWS_PER_BATCH];
    uint16_t SME_CURRLIM_ChargeCurrentLim[ROWS_PER_BATCH];
    uint16_t SME_CURRLIM_DischargeCurrentLim[ROWS_PER_BATCH];
    uint32_t SME_CURRLIM_UNUSED_INT_1[ROWS_PER_BATCH];
...
public:
    void setRow(DataRow row, int idx) {
        ...
        this->SME_THROTL_UNUSED_BIT_1[idx/8] |= row.SME_THROTL_UNUSED_BIT_1 << idx%8;
        this->SME_THROTL_PowerReady[idx/8] |= row.SME_THROTL_PowerReady << idx%8;
        this->SME_THROTL_UNUSED_BIT_2[idx/8] |= row.SME_THROTL_UNUSED_BIT_2 << idx%8;
        this->SME_THROTL_UNUSED_BIT_3[idx/8] |= row.SME_THROTL_UNUSED_BIT_3 << idx%8;
        this->SME_THROTL_UNUSED_BIT_4[idx/8] |= row.SME_THROTL_UNUSED_BIT_4 << idx%8;
        this->SME_THROTL_UNUSED_BIT_5[idx/8] |= row.SME_THROTL_UNUSED_BIT_5 << idx%8;
        this->SME_THROTL_MBB_Alive[idx] = row.SME_THROTL_MBB_Alive;
        this->SME_THROTL_UNUSED_BIT_6[idx/8] |= row.SME_THROTL_UNUSED_BIT_6 << idx%8;
        this->SME_THROTL_UNUSED_BIT_7[idx/8] |= row.SME_THROTL_UNUSED_BIT_7 << idx%8;
        this->SME_THROTL_UNUSED_BIT_8[idx/8] |= row.SME_THROTL_UNUSED_BIT_8 << idx%8;
        this->SME_THROTL_UNUSED_BIT_9[idx/8] |= row.SME_THROTL_UNUSED_BIT_9 << idx%8;
