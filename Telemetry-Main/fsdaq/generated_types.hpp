...
class DataBatch {
    ...
    uint8_t PDB_POWER_A_CURRENT_SHUTDOWN[Rows];
    uint8_t PDB_POWER_A_CURRENT_ACC[Rows];
    uint8_t PDB_POWER_A_CURRENT_ETC[Rows];
    uint8_t PDB_POWER_A_CURRENT_BPS[Rows];
    uint8_t PDB_POWER_A_CURRENT_TRACTIVE[Rows];
    uint8_t PDB_POWER_A_CURRENT_BSPD[Rows];
    uint8_t PDB_POWER_B_CURRENT_TELEMETRY[Rows];
    uint8_t PDB_POWER_B_CURRENT_PDB[Rows];
    uint8_t PDB_POWER_B_CURRENT_DASH[Rows];
    uint8_t PDB_POWER_B_CURRENT_RTML[Rows];
    uint8_t PDB_POWER_B_CURRENT_EXTRA_1[Rows];
    uint8_t PDB_POWER_B_CURRENT_EXTRA_2[Rows];
...
template<int Rows>
inline void write_fsdaq_batch(DataBatch<Rows> *batch, FILE *file) {
