...
struct ValuesRow {
    ...
    float ACC_SEG5_VOLTS_CELL0;
    float ACC_SEG5_VOLTS_CELL1;
    float ACC_SEG5_VOLTS_CELL2;
    float ACC_SEG5_VOLTS_CELL3;
    float ACC_SEG5_VOLTS_CELL4;
    float ACC_SEG5_VOLTS_CELL5;
    int8_t ACC_SEG5_TEMPS_CELL0;
    int8_t ACC_SEG5_TEMPS_CELL1;
    int8_t ACC_SEG5_TEMPS_CELL2;
    int8_t ACC_SEG5_TEMPS_CELL3;
    int8_t ACC_SEG5_TEMPS_CELL4;
    int8_t ACC_SEG5_TEMPS_CELL5;
...
public:
    void setRow(ValuesRow row, int idx) {
        ...
        this->ACC_STATUS_PRECHARING[idx/8] |= row.ACC_STATUS_PRECHARING << idx;
        ...
        this->ACC_SEG5_VOLTS_CELL0[idx] = row.ACC_SEG5_VOLTS_CELL0;
        this->ACC_SEG5_VOLTS_CELL1[idx] = row.ACC_SEG5_VOLTS_CELL1;
        this->ACC_SEG5_VOLTS_CELL2[idx] = row.ACC_SEG5_VOLTS_CELL2;
        this->ACC_SEG5_VOLTS_CELL3[idx] = row.ACC_SEG5_VOLTS_CELL3;
        this->ACC_SEG5_VOLTS_CELL4[idx] = row.ACC_SEG5_VOLTS_CELL4;
        this->ACC_SEG5_VOLTS_CELL5[idx] = row.ACC_SEG5_VOLTS_CELL5;
        this->ACC_SEG5_TEMPS_CELL0[idx] = row.ACC_SEG5_TEMPS_CELL0;
        this->ACC_SEG5_TEMPS_CELL1[idx] = row.ACC_SEG5_TEMPS_CELL1;
        this->ACC_SEG5_TEMPS_CELL2[idx] = row.ACC_SEG5_TEMPS_CELL2;
        this->ACC_SEG5_TEMPS_CELL3[idx] = row.ACC_SEG5_TEMPS_CELL3;
        this->ACC_SEG5_TEMPS_CELL4[idx] = row.ACC_SEG5_TEMPS_CELL4;
        this->ACC_SEG5_TEMPS_CELL5[idx] = row.ACC_SEG5_TEMPS_CELL5;
